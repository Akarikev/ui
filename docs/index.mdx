...
<CardGroup cols={2}>
  ...
  <Card title="Theming" icon="palette" href="/docs/get-started/theming">
    Customize colors, radius, and dark mode tokens.
  </Card>
  <Card title="CLI Reference" icon="terminal" href="/docs/get-started/cli">
    All elorm CLI commands and flags.
  </Card>
  <Card title="Components" icon="cube" href="/docs/components/button">
