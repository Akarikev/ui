---
title: Introduction
description: "elorm/ui — beautiful copy-paste React components with Base UI or Radix UI."
---
...
Built on **Base UI or Radix UI** (your choice) and **Tailwind CSS v4**, with OKLCH color tokens, theme presets, and an AI-friendly CLI. Install the [agent skill](/docs/get-started/agent-skills) so Cursor, Claude, and Codex follow elorm/ui conventions:
